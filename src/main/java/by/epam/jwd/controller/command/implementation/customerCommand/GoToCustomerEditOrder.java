...
public class GoToCustomerEditOrder implements Command {
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Car car = null;
        Order order = null;
        String customerName = (String) request.getSession().getAttribute("userFullName");
        ...
        try {
            if(edit_id != null && !("".equals(edit_id))) {
                ...
                order.setAdminName(customerName);
            }
