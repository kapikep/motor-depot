...
public final class MariaDBConnectionPool extends ConnectionPool {
    ...
    public void initPoolData() throws DAOException {
        ...
        int POOL_SIZE = Integer.parseInt(bundle.getString("poolsize"));
        String DRIVER_NAME = bundle.getString("driver");
    ...
    public void returnConnection(Connection connection, Statement statement, ResultSet resultSet) throws DAOException {
    ...
    private static void closeConnectionsQueue(BlockingQueue<Connection> queue) throws SQLException {
        Connection connection;
