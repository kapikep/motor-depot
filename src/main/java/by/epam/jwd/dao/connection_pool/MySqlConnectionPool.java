...
public final class MySqlConnectionPool {
    ...
    private final String url = "jdbc:mysql://localhost:3306/Motor_deport";
    ...
    public static MySqlConnectionPool getPooledConnection() {
        return INSTANCE;
    }
    ...
    public void returnConnection(Connection connection, Statement statement, ResultSet resultSet) {
        try {
            if (connection != null) {
                ...
                throw new SQLException("Send null");
            }
